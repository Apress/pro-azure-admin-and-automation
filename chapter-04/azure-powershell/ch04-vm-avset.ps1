...
$avSet = New-AzAvailabilitySet -ResourceGroupName $rgName -Location $location -Name $avSetName -PlatformFaultDomainCount 2 -PlatformUpdateDomainCount 3 -Sku Aligned -Tag $tags
